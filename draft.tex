...
\title{A Module Specification, Implementation and Verification of JSON}
...
\author[1]{Chao Wang}
\affil[1]{Institut de Recherche en Informatique Fondamentale, \\ \texttt{\{cenea,wangch\}@irif.fr}}
